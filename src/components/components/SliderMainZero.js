 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6 m-auto">
              ...
              <h1 className="text-center">Business Meetings</h1>
              </Reveal>
              <Reveal className='onStep' keyframes={fadeInUp} delay={600} duration={600}>
              <p className="lead text-center">
              {/* Play to earn in GameRee Metaverse is going to be a big part of industry. Are you ready to attend an event in the metaverse ? */}
              </p>
              </Reveal>
